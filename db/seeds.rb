...
Transaction.create([
  {stock: stocks[3], user: users[1], kind: "PURCHASE"},
  {stock: stocks[1], user: users[10], kind: "PURCHASE"},
  {stock: stocks[4], user: users[3], kind: "PURCHASE"},
  {stock: stocks[5], user: users[4], kind: "PURCHASE"},
  {stock: stocks[14], user: users[1], kind: "PURCHASE"},
  {stock: stocks[14], user: users[10], kind: "PURCHASE"},
  {stock: stocks[14], user: users[8], kind: "PURCHASE"},
  {stock: stocks[18], user: users[7], kind: "PURCHASE"},
  {stock: stocks[17], user: users[7], kind: "PURCHASE"},
  {stock: stocks[18], user: users[11], kind: "PURCHASE"},
  {stock: stocks[11], user: users[11], kind: "PURCHASE"},
  {stock: stocks[11], user: users[11], kind: "PURCHASE"},
  {stock: stocks[11], user: users[11], kind: "PURCHASE"},
  {stock: stocks[11], user: users[11], kind: "PURCHASE"},
  {stock: stocks[9], user: users[11], kind: "PURCHASE"},
  {stock: stocks[3], user: users[11], kind: "PURCHASE"},
  {stock: stocks[17], user: users[11], kind: "PURCHASE"},
  {stock: stocks[13], user: users[11], kind: "PURCHASE"}
])
